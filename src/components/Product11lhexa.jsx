...
import productbg from "../images/hexabg.jpg";
    ...
    <div className="bg-card font-para2">
      <div className="bg-card">
        <div className="relative">
          <img src={productbg} alt="" className="w-full h-[600px]" />

          <h1 className="absolute top-60 left-1/4 transform -translate-x-1/2 text-center text-xl md:text-5xl  text-black font-heading">
           11L-HEXA
          </h1>
        </div>
